...
public class DeleteFriendContact extends JFrame implements ActionListener {
		...
		public static void main(String[] args) {
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						DeleteFriendContact frame = new DeleteFriendContact();
		...
		public void deletefriendContact() {
			...
			if (contactData.equalsIgnoreCase("Select contact")) {
				...
				if (option == 0) {
					...
					String deleteQuery = "delete from friend where phoneNumber=?";
					try {
